 ...
 */
final class Version20260211111708 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE board_member (id INT AUTO_INCREMENT NOT NULL, board_id INT NOT NULL, user_id INT NOT NULL, role VARCHAR(32) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_DCFABEDFE7EC5785 (board_id), INDEX IDX_DCFABEDFA76ED395 (user_id), UNIQUE INDEX board_member_unique (board_id, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE board_member ADD CONSTRAINT FK_DCFABEDFE7EC5785 FOREIGN KEY (board_id) REFERENCES board (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE board_member ADD CONSTRAINT FK_DCFABEDFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
